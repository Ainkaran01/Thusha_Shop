...
from .views import FrameTypeViewSet,CategoryViewSet, ProductViewSet,AccessoryViewSet, product_category_counts, product_detail,product_reviews
...
urlpatterns = [
    ...
    path('<int:pk>/reviews/', product_reviews, name='product-reviews'),
     path('category-counts/', product_category_counts),
]
